 ...
 * @link       http://themehybrid.com/themes/rakiya
...
function rakiya_content_image_sizes_attr( $sizes, $size ) {
    $width = $size[0];
...
add_filter( 'wp_calculate_image_sizes', 'rakiya_content_image_sizes_attr', 10 , 2 );
